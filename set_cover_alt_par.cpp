...
void initializePopulation(int size, population_set * population, std::mt19937 * random_generator, 
...
std::pair<individual,individual> chooseParents(population_set * population, std::mt19937 * random_generator) {
    std::vector<std::pair<double, individual>> probability_vector;
    auto real_rand = std::bind(std::uniform_real_distribution<double> (0,1), *random_generator);
